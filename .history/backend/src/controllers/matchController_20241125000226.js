...
const matchController = {
    ...
    async acceptMatch(req, res) {
        const user_id = req.quert.user_id; // Extracting user_id from query params
        const matched_user_id = req.querty.matched_user_id; // Expecting matched_user_id in the request body
