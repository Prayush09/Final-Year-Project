0const Profile = require('../models/Profile');

const profileController = {
    async createProfile(req, res) {
        try{
            const profileData = {...req.body, user_id: req.query.user_id };
    ...
    async getProfile(req, res){
        try{
            const profile = await Profile.getProfileByUserId(req.query.user_id);
    ...
    async updateProfile(req, res){
        try{
            ...
            const updateProfile = await Profile.updateProfile(req.query.user_id, profileData);
    ...
    async deleteProfile(req, res){
        try{
            const result = await Profile.deleteProfile(req.query.user_id);
