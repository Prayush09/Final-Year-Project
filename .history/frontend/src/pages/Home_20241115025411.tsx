...
export default function Home() {
  ...
  <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 animate-border-glow rounded-full"></div>
  <Button
    variant="default"
    size="lg"
    className="relative z-10 text-white bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-full transition duration-500 ease-in-out"
  >
    Get Started!
  </Button>
</div>
