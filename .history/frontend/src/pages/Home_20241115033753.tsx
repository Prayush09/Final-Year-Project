...
export default function Home() {
  ...
  <div className="absolute inset-0 rounded-lg border-[4px] border-transparent bg-gradient-to-r from-[#f79533] via-[#f37055] to-[#1098ad] z-[-1] animate-gradient-background"></div>
