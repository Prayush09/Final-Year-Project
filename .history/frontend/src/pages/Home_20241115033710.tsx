    ...
    <>
      <div className="relative h-screen">
        ...
        <div className="main-headings flex flex-col justify-center items-center text-center relative z-10 pt-36">
          ...
          <div className="relative inline-block rounded-lg bg-transparent p-[var(--borderWidth)]">
  {/* Glowing Gradient Border */}
  <div className="absolute inset-0 rounded-lg border-[3px] border-transparent bg-gradient-to-r from-[#f79533] via-[#f37055] to-[#1098ad] z-[-1] animate-gradient-background"></div>

  {/* Button */}
  <Button
    variant="default"
    size="lg"
    className="relative z-10 rounded-lg px-8 py-4 text-white bg-transparent overflow-hidden transition duration-500 ease-in-out"
  >
    Get Started!
  </Button>
</div>
