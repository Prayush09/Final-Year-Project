      ...
      <div className="relative h-screen">
        ...
        <div className="main-headings flex flex-col justify-center items-center text-center relative z-10 pt-36">
          ...
          <Button
            variant="default"
            size="lg"
            className="rounded-full transi  bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 hover:bg-gradient-to-r hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500"
            >
            Get Started!
          </Button> 
        </div>
