...
export default function Home() {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-blue-600 rounded-full p-0.5 blur-sm motion-safe:animate-spin-slow">
      ...
      <Button 
        variant="default"
        size="lg"
        className="relative z-10 rounded-full px-8 py-4 bg-transparent hover:bg-black/80 text-white transition-colors duration-300"
      >
        Get Started!
      </Button>
    </div>
