...
export default function Home() {
  return (
    ...
    <div className="main-headings ">
      ...
      <p>
      Finding the perfect roommate just got easier. Say goodbye to endless scrolling and awkward meetups—Homeey connects you with compatible roommates based on what truly matters.<br /> Your ideal home life is just a match away!
      </p>
      </main>
    </div>
