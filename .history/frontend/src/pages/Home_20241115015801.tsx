      ...
      <div className="main-headings h-screen flex flex-col justify-center items-center text-center">
        <main className="w-full max-w-[1270px] mb-72 px-4  font-grotesk">
          ...
          <p className="text-lg mt-4">
            ...
            Say goodbye to endless scrolling and awkward meetups - <span className=" bg-gradient-to-b from-[#FF1BF7] via-[#8D4DE8] to-[#00EFFF] bg-clip-text text-transparent">Homeey</span> connects you with compatible roommates based on what truly matters.
