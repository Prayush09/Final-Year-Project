...
export default function Home() {
  ...
  <div className="absolute inset-0 bg-gradient-to-r from-[#FF4A42] to-[#0714DD] rounded-full z-0 animate-border-glow"></div>
  
  {/* Button */}
  <Button
    variant="default"
    size="lg"
    className="relative z-10 rounded-full px-8 py-4 text-white bg-[#07080F] overflow-hidden transition duration-500 ease-in-out"
  >
    Get Started!
  </Button>
</div>
