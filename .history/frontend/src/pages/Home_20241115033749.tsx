    ...
    <>
      <div className="relative h-screen">
        ...
        <div className="main-headings flex flex-col justify-center items-center text-center relative z-10 pt-36">
          ...
          <div className="relative inline-block rounded-lg bg-[#1D1F20] p-[var(--borderWidth)]">
  {/* Glowing Gradient Border */}
  <div className="absolute inset-0 rounded-lg border-[10px] border-transparent bg-gradient-to-r from-[#f79533] via-[#f37055] to-[#1098ad] z-[-1] animate-gradient-background"></div>
