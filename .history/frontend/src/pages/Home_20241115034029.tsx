...
export default function Home() {
  ...
  <div className="absolute  bg-gradient-to-r from-[#FF4A42] to-[#0714DD] w-48 h-48 top-[-38px] left-[-12px] z-[-1] motion-safe:animate-spin-slow "></div>
  
  {/* Button */}
  <Button
    variant="default"
    size="lg"
    className="relative border-inherit z-10 rounded-full px-8 py-4 text-white bg-transparent overflow-hidden transition duration-500 ease-in-out"
  >
    Get Started!
  </Button>
</div>
