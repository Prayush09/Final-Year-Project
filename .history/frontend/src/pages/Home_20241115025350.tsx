    ...
    <>
      <div className="relative h-screen">
        ...
        <div className="main-headings flex flex-col justify-center items-center text-center relative z-10 pt-36">
          ...
          <div className="relative rounded-full before:background-conic-gradient(transparetnt 270deg, white, transparent) transform-translate-[-50%] aspect-ratio-1">
          <Button
            variant="default"
            size="lg"
            className="rounded-full transition duration-500 ease-in-out absolute"
            >
            Get Started!
          </Button> 
          </div>
