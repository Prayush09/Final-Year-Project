...
export default function ProfileForm() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      const cards = document.getElementsByClassName('profile-container');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900/20 to-transparent py-12 px-6">
      <div className="max-w-3xl mx-auto">
        <Card className="profile-container bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm shadow-xl">
          <CardHeader>
