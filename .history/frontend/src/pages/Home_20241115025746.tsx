...
export default function Home() {
  ...
  {/* Glowing border behind the button */}
  <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-full opacity-30 animate-glow"></div>
  
  {/* Button */}
  <Button
    variant="default"
    size="lg"
    className="relative z-10 text-white bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-full px-8 py-4 transition duration-500 ease-in-out"
  >
    Get Started!
  </Button>
</div>
