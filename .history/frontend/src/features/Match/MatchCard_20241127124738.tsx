...
export function MatchCard({
  ...
  const getAnimatedAvatar = (gender: string) => {
    return gender.toLowerCase() === 'female'
      ...
      : 'https://plus.unsplash.com/premium_vector-1727958429090-b18a0a88fba1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bWFsZSUyMHByb2ZpbGV8ZW58MHx8MHx8fDA%3Dx  ';
  };
