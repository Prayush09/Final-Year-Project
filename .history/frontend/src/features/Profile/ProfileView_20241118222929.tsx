      ...
      <Card className="profile-container bg-white dark:bg-transparent shadow-xl">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div>
             iv className="flex justify-end pt-6">
              <Button onCli <h3 className="font-semibold">Preferred City:</h3>
              <p>{User.location_preferences}</p>
            </div>

            <dck={() => setIsEditing(true)}>Edit Profile</Button>
            </div>
          </div>
        </CardContent>
      </Card>
...
// How do you pass a boolean flag from one tsx file to another...