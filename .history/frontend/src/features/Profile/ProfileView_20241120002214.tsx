  ...
  <div>
    ...
    <div className="flex items-center space-x-2">
      <Slider
        ...
        className="w-full" // Ensure it adjusts to the container width
      />
      <p className="text-violet-600 dark:text-violet-300">{user.cleanliness}</p> {/* Display the value next to the slider */}
    </div>
  </div>
  ...
  <div>
    ...
    <div className="flex items-center space-x-2">
      <Slider
        ...
        className="w-full" // Ensure it adjusts to the container width
      />
      <p className="text-violet-600 dark:text-violet-300">{user.noise_tolerance}</p> {/* Display the value next to the slider */}
    </div>
  </div>
</div>
