...
export default function ViewProfile() {
  ...
  return (
    <div className="min-h-screen  w-full flex items-center justify-center p-4 bg-transparent dark:bg-transparent">
      <div className="relative w-full max-w-3xl">
        {/* Moving Border Component */}
        <MovingBorder />
        {/* Card */}
        <Card className="relative bg-white dark:bg-black-900 shadow-xl m-[2px] backdrop-blur-sm">
          <CardHeader>
