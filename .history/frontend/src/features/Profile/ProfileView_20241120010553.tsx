...
export default function ViewProfile() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-transparent dark:bg-transparent">
      <div className="relative w-full max-w-3xl -mt-16"> {/* Added negative margin top to shift up */}
