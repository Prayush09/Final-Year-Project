...
import external from './ProfileContainer.module.css';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ProfileForm() {
  ...
  return (
    <div className="profile-container max-w-3xl mx-auto p-6">
      <Card className="bg-white dark:bg-transparent shadow-xl">
        <CardHeader>
