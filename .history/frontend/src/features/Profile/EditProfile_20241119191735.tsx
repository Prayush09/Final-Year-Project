...
export default function ProfileForm() {
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    try {
      ...
      const response = await axios.get("http://localhost:3000/api/users/userId", dataToSend);
      console.log(response.data);
      const user_id = response.data.user_id; // Correctly access user_id from response data
