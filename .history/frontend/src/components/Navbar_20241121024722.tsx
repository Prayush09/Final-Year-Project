...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      {/* Navbar Container */}
      <div
        className="py-3 px-5 w-full  container mx-auto flex justify-between items-center dark:bg-background bg-white pb-2 overflow-hidden"
      >
        {/* Logo Section */}
        <div className="flex items-center">
          <Link to="/" className="text-3xl font-extrabold bg-gradient-to-b from-[#FF1BF7] via-[#8D4DE8] to-[#00EFFF] bg-clip-text text-transparent">
            Homeey
          </Link>
        </div>
