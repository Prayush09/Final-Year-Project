...
export default function Navbar() {
  ...
  return (
    <header className="relative">
      <div
        className="py-4 px-5 w-full border-b-2 container mx-auto flex justify-between items-center dark:bg-background bg-white pb-2 overflow-hidden"
        style={{ position: "relative" }} // Ensures `absolute` positioned elements stay within this container
      >
        {/* Logo Section */}
      ...
      {/* Lamp Container */}
      <LampContainer className="absolute -bottom-[12px] left-0" />
    </header>
  );
}
