...
export default function Navbar() {
  ...
  return (
    <header className='pt-4 px-5 flex justify-evenly items-center'>
      <div className="container ml-5 py-3">
            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link to="/" className="group h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors  hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              ...
              <div className="space-x-2">
                ...
                <Button asChild>
                  <Link to="/signup"><span className='text-lg transition-colors hover:text-white'>Sign Up</span></Link>
                </Button>
              </div>
            )}
          </div>
